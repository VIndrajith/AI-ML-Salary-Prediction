...
Original file is located at
    https://colab.research.google.com/drive/1y6-L1cmeokeGfCzZFEssn4_qrcx1eBj9
...
df = pd.read_csv('/content/drive/MyDrive/Internship/m_adult.csv')               # loading the modified dataset
df
